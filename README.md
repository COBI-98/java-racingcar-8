...
- [X] 경주할 자동차를 생성할 수 있다.
  - [X] 각 자동차에 이름을 부여할 수 있다. 
    - [X] 자동차는 쉼표(,)를 기준으로 구분하여 생성된다.
      - [X] 자동차 이름이 비어있거나 공백일 수 없다.
      - [X] 자동차 이름은 5자 이하만 가능하다.
      - [X] 자동차 이름은 중복으로 사용될 수 없다.
  - [X] 각 자동차가 움직인 거리를 표현할 수 있다.


- [X] 사용자는 몇 번의 이동을 할 것인지 입력할 수 있다.
  - [X] 이동할 횟수는 비어있거나 공백일 수 없다.
  - [X] 이동할 횟수는 0보다 큰 자연수여야 한다.
...
- [ ] 자동차 경주 게임의 최종 우승자를 출력한다.
  - [X] 가장 거리가 먼 자동차의 거리를 확인한다.
    - [X] 같은 거리의 자동차가 있는지 확인한다.
  - [X] 단독 우승자의 경우 우승한 자동차를 출력한다.
  - [X] 우승자가 여러 명일 경우 우승한 자동차 이름을 `,`로 구분한다. 
